...
describe('Listing Users', () => {
  ...
  it('returns 5 users and corresponding size indicators when size is set as 5 in request parameter', async () => {
    await addUsers(11);
  ...
  it('returns page as zero and size as 10 when non numeric query param is provided for both', async () => {
    await addUsers(11);
